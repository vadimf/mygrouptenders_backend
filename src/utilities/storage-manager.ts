...
export class StorageManager {
     ...
     */
    public static getFileTypeData(buffer: Buffer, options?: {allowedMimeTypes?: string[], knownData?: IFileTypeData}): IFileTypeData {
        if ( options && options.knownData && options.knownData.ext && options.knownData.mime ) {
     ...
     */
    public fromUrl(url: string, options?: {allowedMimeTypes?: string[], knownData?: IFileTypeData}): Promise<IStorageUploadingResults> {
     ...
     */
    public fromBuffer(buffer: Buffer, options?: {allowedMimeTypes?: string[], knownData?: IFileTypeData}): Promise<IStorageUploadingResults> {
        const that = this;
        ...
        return new Promise((resolve, reject) => {
            ...
            const fileType: IFileTypeData = StorageManager.getFileTypeData(buffer, options);
     ...
     * @param options
     */
    public fromStream(stream: Stream, options: IFileTypeData): Promise<IStorageUploadingResults> {
        const that = this;
